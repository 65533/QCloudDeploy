...
env TerarkZipTable_indexNestLevel=2 \
    ...
    TerarkZipTable_licenseFile=/usr/local/.license
    /opt/mongo/mongod --storageEngine=rocksdb --config=$Config  --dbpath=/mongo_terocks/data
